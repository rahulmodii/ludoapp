        ...
        <div class="card card-flush h-lg-100">
            ...
            <div class="card-header pt-7">
                ...
                <div class="card-toolbar">
                    <a href="#" class="btn btn-sm btn-light" data-bs-toggle="tooltip" data-bs-dismiss="click" data-bs-custom-class="tooltip-inverse" data-bs-original-title="Logistics App is coming soon" data-kt-initialized="1">Ludo Rules</a>
                </div>
                <!--end::Toolbar-->
            </div>
            <!--end::Header-->
            ...
            <div class="card-body">
                ...
                <ul class="nav nav-pills nav-pills-custom row position-relative mx-0 mb-9" role="tablist">
                    ...
                    <li class="nav-item col-6 mx-0 p-0" role="presentation">
                        <!--begin::Link-->
                        <a class="nav-link d-flex justify-content-center w-100 border-0 h-100 active" data-bs-toggle="pill" href="#kt_list_widget_10_tab_1" aria-selected="false" role="tab" tabindex="-1">
                            <!--begin::Subtitle-->
                    ...
                    <li class="nav-item col-6 mx-0 px-0" role="presentation">
                        <!--begin::Link-->
                        <a class="nav-link d-flex justify-content-center w-100 border-0 h-100" data-bs-toggle="pill" href="#kt_list_widget_10_tab_2" aria-selected="false" role="tab" tabindex="-1">
                            <!--begin::Subtitle-->
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade active show" id="kt_list_widget_10_tab_1" role="tabpanel">
                        <div class="d-flex border border-gray-300 border-dashed rounded p-6 mb-6 animate__animated animate__flash animate__slow animate__infinite">
                            <!--begin::Block-->
                            <div class="d-flex align-items-center flex-grow-1 me-2 me-sm-5">
                                ...
                                <!--begin::Section-->
                                <div class="me-2">
                                    <a href="#" class="text-gray-800 text-hover-primary fs-6 fw-bold">CHALLENGE FROM GTUODLME</a>
                                    <span class="text-gray-400 fw-bold d-block fs-7">ENTRY FEE/PRIZE</span>
                                </div>
                                <!--end::Section-->
                            </div>
                            <!--end::Block-->
                            ...
                            <div class="d-flex align-items-center">
                                <span class="text-dark fw-bolder fs-2x">150</span>
                                <span class="fw-semibold fs-2 text-gray-600 mx-1 pt-1">/</span>
                                <span class="text-gray-600 fw-semibold fs-2 me-3 pt-2">277.5</span>
                                <a class="btn btn-sm btn-primary me-2" href="apps/ecommerce/sales/listing.html">Play</a>
                            </div>
                            <!--end::Info-->
                        </div>
                        <div class="d-flex border border-gray-300 border-dashed rounded p-6 mb-6 animate__animated animate__flash animate__slow animate__infinite">
