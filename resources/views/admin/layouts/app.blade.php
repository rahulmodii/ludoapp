					...
					<div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
						...
						<div class="container-xxl d-flex flex-grow-1 flex-stack">
							...
							<div class="d-flex align-items-center me-5">
								...
								<a href="index.html">
									<img alt="Logo" src="assets/media/logos/demo16.svg" class="h-25px h-lg-30px me-2 me-lg-9" />
								</a>
								
								
								<div class="d-flex align-items-center">
									
									<div class="d-none d-lg-inline text-white fw-bold fs-4">Project</div>
									...
									<div class="d-flex px-2 px-lg-4">
										...
										<button type="button" data-kt-element="selected" class="btn btn-outline btn-nav btn-flex px-3 px-lg-4 w-60px w-lg-225px h-45px" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" data-kt-menu-offset="0px, -1px">
											...
											<img alt="Logo" src="assets/media/svg/brand-logos/plurk.svg" data-kt-element="logo" class="h-20px h-lg-25px" />
											...
											<div class="hover-scroll-y h-250px my-3 pe-5 me-n1">
												...
												<div class="menu-item">
													...
													<a href="" class="menu-link px-3 py-3 active">
														...
														<span class="d-flex flex-center flex-shrink-0 w-30px me-2">
															<img alt="Logo" src="assets/media/svg/brand-logos/plurk.svg" data-kt-element="logo" class="h-20px" />
														</span>
												...
												<div class="menu-item">
													...
													<a href="" class="menu-link px-3 py-3">
														...
														<span class="d-flex flex-center flex-shrink-0 w-30px me-2">
															<img alt="Logo" src="assets/media/svg/brand-logos/slack-icon.svg" data-kt-element="logo" class="h-20px" />
														</span>
												...
												<div class="menu-item">
													...
													<a href="" class="menu-link px-3 py-3">
														...
														<span class="d-flex flex-center flex-shrink-0 w-30px me-2">
															<img alt="Logo" src="assets/media/svg/brand-logos/dribbble-icon-1.svg" data-kt-element="logo" class="h-20px" />
														</span>
												...
												<div class="menu-item">
													...
													<a href="" class="menu-link px-3 py-3">
														...
														<span class="d-flex flex-center flex-shrink-0 w-30px me-2">
															<img alt="Logo" src="assets/media/svg/brand-logos/bootstrap5.svg" data-kt-element="logo" class="h-20px" />
														</span>
												...
												<div class="menu-item">
													...
													<a href="" class="menu-link px-3 py-3">
														...
														<span class="d-flex flex-center flex-shrink-0 w-30px me-2">
															<img alt="Logo" src="assets/media/svg/brand-logos/spotify-2.svg" data-kt-element="logo" class="h-20px" />
														</span>
												...
												<div class="menu-item">
													...
													<a href="" class="menu-link px-3 py-3">
														...
														<span class="d-flex flex-center flex-shrink-0 w-30px me-2">
															<img alt="Logo" src="assets/media/svg/brand-logos/beats-electronics.svg" data-kt-element="logo" class="h-20px" />
														</span>
							...
							<div class="topbar d-flex align-items-stretch flex-shrink-0" id="kt_topbar">
								...
								<div class="d-flex align-items-center ms-2 ms-lg-4" id="kt_header_user_menu_toggle">
									...
									<div class="cursor-pointer symbol symbol-30px symbol-lg-40px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
										<img class="symbol symbol-30px symbol-lg-40px" src="assets/media/avatars/300-3.jpg" alt="user" />
									</div>
											...
											<div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item here show menu-lg-down-accordion">
												...
												<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px">
													...
													<div class="menu-item">
														...
														<a class="menu-link active py-3" href="apps/subscriptions/list.html">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
						...
						<div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
							...
							<div class="page-title d-flex flex-column">
								...
								<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 mb-1">
									...
									<li class="breadcrumb-item text-gray-700 fw-bold lh-1">Subscriptions</li>
									...
									<li class="breadcrumb-item text-gray-500">Subscription List</li>
									
								</ul>
								
								
								<h1 class="page-heading d-flex flex-column justify-content-center text-gray-900 fw-bolder fs-3 m-0">Subscriptions List</h1>
